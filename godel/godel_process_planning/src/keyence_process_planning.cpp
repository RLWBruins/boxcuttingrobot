...
const double BLENDING_ANGLE_DISCRETIZATION =
    2.0*M_PI; // The discretization of the tool's pose about
                 // the z axis [Box-cutting project : This is changed from M_PI/12.0 (as in the original Godel code) to M_PI/4.0 in order to get the arm move perpendicular on the surface.]
