                                            ...
                                            ProcessPathResult& result)
{
  ...
  */
  // For the box-cutting project we do not need to generate a blend path
    process_planning_feedback_.last_completed = "Skip generating blend path for surface " + name;
    process_planning_server_.publishFeedback(process_planning_feedback_);
  ...
  */
  ...
  // For the box-cutting project we do not need to generate a edge path
  process_planning_feedback_.last_completed = "Skip generating edge path for surface " + name;
  process_planning_server_.publishFeedback(process_planning_feedback_);
