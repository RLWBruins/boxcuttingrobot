...
int main(int argc, char** argv)
{
  ...
  bp_req.params.blending_spd = .001;
  bp_req.params.retract_spd = .005;
  bp_req.params.traverse_spd = .005;      // Dit is de scan snelheid, aanpassen tot max 0.2? kan ook via process_planning.yaml
